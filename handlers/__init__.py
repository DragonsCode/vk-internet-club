...
from .instructions import instructions_labeler
from .ref_system import ref_labeler
...
__all__ = ("donut_labeler", "my_club_labeler", "tariffs_labeler", "admin_labeler", "instructions_labeler", "ref_labeler")